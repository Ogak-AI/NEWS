...
export const FALLBACK_ARTICLES = [
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Primary Source Cross-Reference (SpaceX Telemetry)",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Matched tank telemetry updates with public regulatory filings."
        },
        {
          "method": "Industry Consensus Check",
          "status": "verified",
          "confidence": 0.96,
          "detail": "Aligned with independent analysis from SpaceNews and ArsTechnica."
        },
        {
          "method": "Semantic Bias Analysis",
          "status": "verified",
          "confidence": 0.98,
          "detail": "Neutral technical sentiment detected; no promotional language flagged."
        }
      ],
      "sources": [
        {
          "publisher": "SpaceX Operations",
          "url": "https://spacex.com/updates",
          "title": "Starship Payload Architecture Update"
        },
        {
          "publisher": "SpaceNews",
          "url": "https://spacenews.com",
          "title": "Analyst perspective on dry mass reduction"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Report Origin Verification",
          "status": "verified",
          "confidence": 1.0,
          "detail": "BIS securely hosted PDF cryptographically hashed and verified."
        },
        {
          "method": "Economic Sentiment Alignment",
          "status": "verified",
          "confidence": 0.92,
          "detail": "Cross-referenced ECB timelines with Reuters terminal data."
        }
      ],
      "sources": [
        {
          ...
          "url": "https://bis.org",
          "title": "CBDC Global Shift 2026 Report"
        },
        {
          "publisher": "Reuters",
          "url": "https://reuters.com",
          "title": "ECB digital euro investigation timeline"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Peer-Review Validation Check",
          "status": "verified",
          "confidence": 0.98,
          "detail": "Cross-referenced DOI with Nature publishing database."
        },
        {
          "method": "Computational Fidelity Analysis",
          "status": "verified",
          "confidence": 0.89,
          "detail": "Verified baseline classical limits against Top500 supercomputer specs."
        }
      ],
      "sources": [
        {
          ...
          "title": "Quantum Simulation of MoFe-cofactor in Nitrogenase"
        },
        {
          "publisher": "MIT News",
          "url": "https://mit.edu/news",
          "title": "A new era in chemical simulation"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Satellite Telemetry Sync",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Ingested raw volume datasets from ICESat-2 APIs."
        },
        {
          "method": "Meteorological Consensus",
          "status": "verified",
          "confidence": 0.95,
          "detail": "Matched jet stream displacement models with NOAA forecast records."
        }
      ],
      "sources": [
        {
          ...
          "url": "https://npolar.no",
          "title": "Cryosphere rapid observation bulletin"
        },
        {
          "publisher": "ESA",
          "url": "https://esa.int/cryosat",
          "title": "CryoSat-2 Ice Volume Retrospect"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Regulatory Database Check",
          "status": "verified",
          "confidence": 1.0,
          "detail": "Queried FDA Approvals registry and confirmed NDA 218534 status."
        },
        {
          "method": "Clinical Trial Corroboration",
          "status": "verified",
          "confidence": 0.97,
          "detail": "Verified Phase 3 efficacy stats against ClinicalTrials.gov NCT05XXXXXX."
        }
      ],
      "sources": [
        {
          "publisher": "FDA",
          "url": "https://fda.gov",
          "title": "Novel Approvals: LupCel for SLE"
        },
        {
          "publisher": "New England Journal of Medicine",
          "url": "https://nejm.org",
          "title": "Allogeneic CAR-T efficacy in refractory lupus"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Legislative Status Sync",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Confirmed EU Parliament Directive 2026/89 entering into force."
        },
        {
          "method": "Corporate Response Matching",
          "status": "verified",
          "confidence": 0.91,
          "detail": "Analyzed public SEC filings and PR from Anthropic and OpenAI regarding EU compliance."
        }
      ],
      "sources": [
        {
          ...
          "title": "Generative AI Compensation Pool Framework"
        },
        {
          "publisher": "Financial Times",
          "url": "https://ft.com",
          "title": "Tech giants brace for EU AI levy"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Supply Chain Analytics",
          "status": "verified",
          "confidence": 0.95,
          "detail": "Cross-referenced factory tooling orders and raw material futures."
        },
        {
          "method": "Press Release Authenticity",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Verified corporate communications from Toyota Motor Corporation."
        }
      ],
      "sources": [
        {
          ...
          "title": "Toyota-Panasonic JV opens SS gigafactory"
        },
        {
          "publisher": "BloombergNEF",
          "url": "https://bnef.com",
          "title": "EV Battery Price Outlook 2027"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Treaty Proceedings Parsing",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Ingested live UN ISA Kingston plenary transcripts."
        },
        {
          "method": "Geopolitical Alignment Check",
          "status": "verified",
          "confidence": 0.96,
          "detail": "Mapped voting block alignments against known Pacific Island Forum stances."
        }
      ],
      "sources": [
        {
          ...
          "title": "29th Session Assembly Records"
        },
        {
          "publisher": "The Guardian",
          "url": "https://theguardian.com",
          "title": "Deep sea mining faces legal limbo"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Air Traffic Control Telemetry",
          "status": "verified",
          "confidence": 0.99,
          "detail": "Tracked UK CAA and Australian CASA airspace restriction notices for exo-flight path."
        },
        {
          "method": "Radar Anomaly Resolution",
          "status": "verified",
          "confidence": 0.94,
          "detail": "Confirmed ballistic trajectory tracking data from amateur radio-sat networks."
        }
      ],
      "sources": [
        {
          ...
          "title": "AeroLogistics validates point-to-point suborbital freight"
        },
        {
          "publisher": "Civil Aviation Safety Authority (AU)",
          "url": "https://casa.gov.au",
          "title": "Exo-freight landing clearance report"
        }
      ],
      "facts": []
    },
  ...
  },
  {
    ...
    "provenance_metadata": {
      "verification_nodes": [
        {
          "method": "Bioreactor Data Verification",
          "status": "verified",
          "confidence": 0.98,
          "detail": "Reviewed effluent mass-spectrometry logs provided by VTT."
        },
        {
          "method": "Ecological Safety Audit",
          "status": "flagged",
          "confidence": 0.91,
          "detail": "Secondary containment protocols met EU standards, but long-term mutation monitoring requires independent review."
        }
      ],
      "sources": [
        {
          "publisher": "VTT Technical Research Centre",
          "url": "https://vttresearch.com",
          "title": "Viikinm\u00e4ki Project Final Report"
        },
        {
          "publisher": "Science Advances",
          "url": "https://science.org",
          "title": "AI-designed synthetic enzymes for mixed polymer degradation"
        }
      ],
      "facts": []
    },
